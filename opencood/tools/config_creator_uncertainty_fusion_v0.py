...
def build_runs():
    ...
    noise_settings = [
        ...
        ("pos_0p2_rot_2p0" , 0.2, 2.0, True),
        ("pos_0p2_rot_4p0" , 0.2, 4.0, True),
        ("pos_0p2_rot_6p0" , 0.2, 6.0, True),
        ...
        ("pos_0p5_rot_4p0" , 0.5, 4.0, True),
        ("pos_0p5_rot_6p0" , 0.5, 6.0, True),
...
def main():
    ...
    manifest_path = OUTPUT_ROOT_DIR / f"{GENERATED_PREFIX}manifest_fusion.csv"
